...
namespace AmplifyColor
{
    public class BackBufferHandler
    {
        ...
        public bool ReadBackBuffer(out ImageResult imageResult)
        {
            ...
            Camera camera = _cameras.SelectedCamera;
            ...
            int width = ToolSettings.Instance.Resolution.TargetWidth;
            int height = ToolSettings.Instance.Resolution.TargetHeight;
            ...
            Color[] colors = text.GetPixels(0, 0, width, height);
