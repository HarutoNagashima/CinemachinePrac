...
public class AmplifyColorEffectEditorBase : Editor
{
    ...
    bool FindClone(AmplifyColorBase effect)
    {
        ...
        GameObject effectPrefab = PrefabUtility.GetCorrespondingObjectFromSource(effect.gameObject);
...
#if UNITY_2018_3_OR_NEWER
            GameObject otherPrefab = PrefabUtility.GetCorrespondingObjectFromSource(other.gameObject);
