...
namespace AmplifyColor
{
    ...
    {
        public ToolSettings Settings => ToolSettings.Instance;
        ...
        private void ShowGUITargetFile()
        {
            ...
            string lutpath = EditorGUILayout.TextField("Save Preset to File", LUTWriter.TexturePath);

            if (GUILayout.Button("Browse"))
            {
                string path = EditorUtility.SaveFilePanelInProject("Save as", Path.GetFileName(LUTWriter.TexturePath), "png", "Please enter a file name to save the texture to");
