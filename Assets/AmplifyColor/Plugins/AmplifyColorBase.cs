...
public class AmplifyColorBase : MonoBehaviour
{
    ...
    private float effectVolumesBlendAdjusted => Mathf.Clamp01(effectVolumesBlendAdjust < 0.99f ? (volumesBlendAmount - effectVolumesBlendAdjust) / (1.0f - effectVolumesBlendAdjust) : 1.0f);
